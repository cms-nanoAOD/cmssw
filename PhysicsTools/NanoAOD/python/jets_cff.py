...
updatedJetsAK8WithUserData = cms.EDProducer("PATJetUserDataEmbedder",
     ...
     userInts = cms.PSet(
        ...
        lep3indexmatch =  cms.InputTag("lepInJetVars:lep3indexmatch"),
     ),
)
for modifier in run2_miniAOD_80XLegacy, run2_nanoAOD_94X2016:
...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
	...
	deepTagMD_TvsQCD = Var("bDiscriminator('pfMassDecorrelatedDeepBoostedDiscriminatorsJetTags:TvsQCD')",float,doc="Mass-decorrelated DeepBoostedJet tagger top vs QCD discriminator",precision=10),
        ...
        lsf3match = Var("userFloat('lsf3match')",float, doc="LSF matched to RECO (3 subjets)",precision=10),
        lep3idmatch = Var("userInt('lep3idmatch')",int, doc="Lep id matched to RECO (3 subjets)"),
        lep3indexmatch = Var("userInt('lep3indexmatch')",int, doc="Lep index matched to RECO (3 subjets)"),
