    ...
    vplots = cms.PSet(
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('lep3idmatch', 'lep3idmatch', 1, -1, 40, 'Lep id matched to RECO (3 subjets)'),
                Plot1D('lep3indexmatch', 'lep3indexmatch', 1, -1, 40, 'Lep index matched to RECO (3 subjets)'),
                Plot1D('lsf3', 'lsf3', 20, -1, 1, 'LSF (3 subjets)'),
                Plot1D('lsf3match', 'lsf3match', 20, -1, -1, 'LSF matched to RECO (3 subjets)'),
