    ...
    vplots = cms.PSet(
        ...
        Tau = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('idCombIsod', 'idCombIsod', 8, -0.5, 7.5, 'Combined isolation (deltaBeta corrections) ID working point: bitmask 1 = Loose, 2 = Medium, 4 = Tight'),
                #Plot1D('idCombIsodR03', 'idCombIsodR03', 8, -0.5, 7.5, 'Combined isolation (deltaBeta corrections, dR=0.3) ID working point: bitmask 1 = Loose, 2 = Medium, 4 = Tight'),
