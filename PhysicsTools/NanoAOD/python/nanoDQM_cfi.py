    ...
    vplots = cms.PSet(
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('btagDDBvL', 'btagDDBvL', 20, inf, -inf, 'DeepDoubleX (mass-decorrelated) discriminator for H(Z)->bb vs QCD'),
                Plot1D('btagDDBvL_noMD', 'btagDDBvL_noMD', 20, 0, 1, 'DeepDoubleX discriminator (no mass-decorrelation) for H(Z)->bb vs QCD'),
                Plot1D('btagDDCvB', 'btagDDCvB', 20, inf, -inf, 'DeepDoubleX (mass-decorrelated) discriminator for H(Z)->cc vs H(Z)->bb'),
                Plot1D('btagDDCvB_noMD', 'btagDDCvB_noMD', 20, 0, 1, 'DeepDoubleX discriminator (no mass-decorrelation) for H(Z)->cc vs H(Z)->bb'),
                Plot1D('btagDDCvL', 'btagDDCvL', 20, inf, -inf, 'DeepDoubleX (mass-decorrelated) discriminator for H(Z)->cc vs QCD'),
        ...
        Muon = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('puppiIsoId', 'puppiIsoId', 1, -0.5, 0.5, 'PuppiIsoId from miniAOD selector (1=Loose, 2=Medium, 3=Tight)'),
